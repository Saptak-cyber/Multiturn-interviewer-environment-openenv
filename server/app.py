...
"""
FastAPI application for the Multiturn Technical Interviewer Environment.

This module creates an HTTP server that exposes the MultiturnTechnicalInterviewerEnvironment
...
app = create_app(
    ...
    env_name="multiturn_technical_interviewer",
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m multiturn_technical_interviewer.server.app
    ...
    multiple workers:
        uvicorn multiturn_technical_interviewer.server.app:app --workers 4
    """
    import uvicorn
